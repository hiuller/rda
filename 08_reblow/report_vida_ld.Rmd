...
Manter as análises no mesmo convertedor ou podemos *misturar* convertedores e campanhas? Pode não ser possível manter as diferenças no mesmo vaso por motivos de disponibilidade de dados. Portanto, estamos decidindo por tratar indistintamente convertedores diferentes. 

Podemos conduzir um estudo *preliminar* usando apenas aços UBC que são mais abundantes e, portanto, vão proporcionar um banco de dados mais homogênio. 
...
Vamos usar os seguintes filtros. Corridas com lança de seis furos (atual), códigos de processo MB, VJ, 30, 24, TN, 31. Vida entre 100 e 1000 ou 2100 e 3000. Depois de obtidos os dados, o primeiro passo será procurar pelos percentuais de sucata mais representativos. 
